...
Button btnback, btnkhampha, btnyeuthich,btnseach, btnthongbao, thapcam;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_com);
        btnback = findViewById(R.id.btnbackcom);
      ...
      //  btnyeuthich = findViewById(R.id.favourite);
        ...
        thapcam     = findViewById(R.id.rangtc);

        thapcam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Com_Thap_Cam.class);
